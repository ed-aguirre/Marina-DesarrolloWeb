<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListarAutos.aspx.cs" Inherits="Frontera.Catalogo.Autos.ListarAutos" %>
            ...
            <asp:GridView ID="gvAutos" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Matricula" ItemStyle-Width="80px"
                        DataField="Matricula" />
                    <asp:BoundField HeaderText="Año" ItemStyle-Width="80px"
                        DataField="Anio" />
                        ...
                        <ItemTemplate>
                            <div style="width:100%">
                                <div style="width:25%;margin:0 auto">
                                    <asp:CheckBox ID="chkDisponible" runat="server" Enabled="false" 
